...
function renderTipsView() {
  ...
  if (
    ...
    !episode.tips[appState.selectedTipIndex]
  ) {
  ...
  const tipText = episode.tips[appState.selectedTipIndex];

  tipPagesCache = paginateText(dom.characterText, tipText);
