...
PREFIX_MAP = [
    ("bmp\\r_click\\cha_btn\\ep4\\", "assets/ui/characters/ep4/icons/"),
    ("bmp\\r_click\\cha_tati\\ep4\\", "assets/ui/characters/ep4/tachi/"),
    ("en\\bmp\\r_click\\text\\cha\\ep4\\", "assets/ui/characters/ep4/reference-text/"),
    ("bmp\\r_click\\cha_btn\\ep4_2\\", "assets/ui/characters/ep4_2/icons/"),
    ("bmp\\r_click\\cha_tati\\ep4_2\\", "assets/ui/characters/ep4_2/tachi/"),
    ("en\\bmp\\r_click\\text\\cha\\ep4_2\\", "assets/ui/characters/ep4_2/reference-text/"),
    ("bmp\\r_click\\cha_btn\\ep4_3\\", "assets/ui/characters/ep4_3/icons/"),
    ("bmp\\r_click\\cha_tati\\ep4_3\\", "assets/ui/characters/ep4_3/tachi/"),
    ("en\\bmp\\r_click\\text\\cha\\ep4_3\\", "assets/ui/characters/ep4_3/reference-text/"),
    ("en\\bmp\\r_click\\tips_btn\\", "assets/ui/tips/ep4/buttons/"),
    ("en\\bmp\\r_click\\text\\tips\\ep4\\", "assets/tips/ep4/"),
]

EXACT_MAP = {
    "assets/ui/characters/ep4/backdrop/cha_back.png": r"bmp\r_click\cha_btn\cha_back.png",
    "assets/ui/characters/ep4_2/backdrop/cha_back15.png": r"bmp\r_click\cha_btn\cha_back15.png",
    "assets/ui/characters/ep4_2/backdrop/ba4_2_7.png": r"bmp\r_click\cha_btn\ba4_2_7.png",
    "assets/ui/characters/ep4_3/backdrop/cha_back3.png": r"bmp\r_click\cha_btn\cha_back3.png",
    "assets/ui/characters/ep4/text/txt_def2.png": r"bmp\r_click\text\txt_def2.png",
    "assets/ui/hana3_back.png": r"en\bmp\r_click\hana3_back.png",
    "assets/ui/system/cha_next.png": r"bmp\r_click\sys_btn\cha_next.png",
    "assets/backgrounds/enj_mirai01.png": r"bmp\background\efe\enj_mirai01.png",
}
...
def target_for_source(source_name):
    ...
    for prefix, target_prefix in PREFIX_MAP:
        ...
        if not filename.endswith(".png"):
            return None
        if target_prefix.endswith("/buttons/") and not filename.startswith("tips4_"):
            return None
...
def main():
    ...
    (ROOT / "assets" / "extracted-ep4.report.json").write_text(
        json.dumps(report, indent=2),
        encoding="utf-8",
    )
    print(f"Extracted EP4 assets: {len(extracted)}")
    print(f"Missing EP4 assets: {len(missing)}")
    if missing:
        for item in missing:
