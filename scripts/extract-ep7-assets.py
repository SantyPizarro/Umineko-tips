...
PREFIX_MAP = [
    ("bmp\\r_click\\cha_btn\\ep7\\", "assets/ui/characters/ep7/icons/"),
    ("bmp\\r_click\\cha_tati\\ep7\\", "assets/ui/characters/ep7/tachi/"),
    ("en\\bmp\\r_click\\text\\cha\\ep7\\", "assets/ui/characters/ep7/reference-text/"),
    ("bmp\\r_click\\cha_btn\\ep7_2\\", "assets/ui/characters/ep7_2/icons/"),
    ("bmp\\r_click\\cha_tati\\ep7_2\\", "assets/ui/characters/ep7_2/tachi/"),
    ("en\\bmp\\r_click\\text\\cha\\ep7_2\\", "assets/ui/characters/ep7_2/reference-text/"),
    ("en\\bmp\\r_click\\tips_btn\\", "assets/ui/tips/ep7/buttons/"),
    ("en\\bmp\\r_click\\text\\tips\\ep7\\", "assets/tips/ep7/"),
]

EXACT_MAP = {
    "assets/ui/characters/ep7/backdrop/EP7_01.png": r"bmp\r_click\cha_btn\EP7_01.png",
    "assets/ui/characters/ep7_2/backdrop/cha_back26.png": r"bmp\r_click\cha_btn\cha_back26.png",
    "assets/ui/characters/ep7/text/txt_def2.png": r"bmp\r_click\text\txt_def2.png",
...
def target_for_source(source_name):
    ...
    for prefix, target_prefix in PREFIX_MAP:
        ...
        if not filename.endswith(".png"):
            return None
        if target_prefix.endswith("/buttons/") and not filename.startswith("tips7_"):
            return None
...
def main():
    ...
    (ROOT / "assets" / "extracted-ep7.report.json").write_text(
        json.dumps(report, indent=2),
        encoding="utf-8"
    )
    print(f"Extracted EP7 assets: {len(extracted)}")
    print(f"Missing EP7 assets: {len(missing)}")
    if missing:
